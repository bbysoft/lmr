...
BOOL __stdcall SFileLoadFileEx(HANDLE *hMpq, char *filename, LPVOID *lplpFileData, LPDWORD lpnFileSize, DWORD nExtraBytesToAllocateAtEnd, DWORD dwSearchScope, LPOVERLAPPED lpOverlapped);
